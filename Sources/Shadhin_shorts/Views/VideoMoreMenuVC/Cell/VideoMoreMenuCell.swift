...
class VideoMoreMenuCell: UICollectionViewCell {
    ...
    private func setupCellUI() {
        ...
        self.separatorView.backgroundColor = .topBarModeType.withAlphaComponent(0.3)
    }
    ...
    func dataBind(data: VideoMoreMenuItems) {
        ...
        self.titleLabel.textColor = data.isRed ?? false ? .red : .textColorModeType
        self.imageView.tintColor = data.isRed ?? false ? .red : .textColorModeType
