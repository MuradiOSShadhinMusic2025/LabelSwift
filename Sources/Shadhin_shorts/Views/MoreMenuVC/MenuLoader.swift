...
struct MoreMenuLoader{
    ...
    @MainActor static func getHeight(content : ContentProtocol, from : MenuFromType)->CGFloat{
        let top : CGFloat = 12 + 28 + 250 + 25 + 24
    ...
    @MainActor static func getMenu(content : ContentProtocol,from : MenuFromType)-> [MoreMenuModel]{
