 ...
 */
 extension UIView {
    ...
    private struct ToastKeys {
        nonisolated(unsafe) static var timer        = "com.toast-swift.timer"
        nonisolated(unsafe) static var duration     = "com.toast-swift.duration"
        nonisolated(unsafe) static var point        = "com.toast-swift.point"
        nonisolated(unsafe) static var completion   = "com.toast-swift.completion"
        nonisolated(unsafe) static var activeToasts = "com.toast-swift.activeToasts"
        nonisolated(unsafe) static var activityView = "com.toast-swift.activityView"
        nonisolated(unsafe) static var queue        = "com.toast-swift.queue"
    }
...
// MARK: - ToastPosition
 ...
 enum ToastPosition {
    ...
    case bottom
     ...
     @MainActor fileprivate func centerPoint(forToast toast: UIView, inSuperview superview: UIView) -> CGPoint {
