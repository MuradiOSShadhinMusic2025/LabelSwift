...
@objc final public class ShadhinShort : NSObject {
    ...
    public static let shared = ShadhinShort()
    ...
    func openSocialMediaLink(name: String, fallbackURL: String) {
        var appURL: URL?
    ...
    public func setupChannelFollowUnFollowing(id: Int, contentType: String) {
    ...
    public func setupLikeDislikeButtons(id: Int, contentType: String) {
    ...
    public func formattedTimeAgo(from dateString: String) -> String {
        let formats = [
