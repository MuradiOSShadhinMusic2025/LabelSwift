...
public class ShadhinShortsApi {
    ...
    // MARK: - Properties
    @MainActor static let shared = ShadhinShortsApi()
    ...
    // MARK: - Methods
    @MainActor func getAudioReelsContents(
    ...
    @MainActor func getChannelHeaderData(contentType: String,
                              id: Int,
                              completion :
    ...
    @MainActor func getMusicContentDetailsData(contentId: Int,
                                    contentType: String,
                                    nextCursor: Int,
                                    pageSize: Int,
                                    completion:
    ...
    @MainActor func getAnalyticsCount(id: Int,
                           contentType: String,
                           completion: @escaping (AnalyticsResponse?, Error?) -> Void) {
        ...
        .responseDecodable(of: AnalyticsResponse.self) { response in
            ...
            case .failure(_):
                let error = NSError(
                    domain: "",
                    code: 500,
                    userInfo: [NSLocalizedDescriptionKey: "Experiencing technical problems now which will be fixed soon. Thanks for your patience."]
                )
                completion(nil, error)
                print(response.error?.localizedDescription as Any)
            }
    ...
    @MainActor func getForYouAudioRellsContents(
    ...
    @MainActor func getAllFavoriteData(completion:
    ...
    @MainActor func favoriteAddData(id: Int,
                         contentType: String,
    ...
    @MainActor func favoriteDeleteData(id: Int,
                            contentType: String,
                            completion: @escaping ([String: Any]?, Error?) -> Void) {
    ...
    @MainActor func getPlayUrl(contentType: String, streamingUrlPath: String, complete: @escaping (String?, String?) -> Void) {
    ...
    @MainActor func surveySubmitData(id: Int,
                         contentType: String,
    ...
    @MainActor func getAllCommentsData(contentId: Int,
                            usercode: Int,
                            pageSize: Int,
                            nextCursor: Int,
                            completion:
    ...
    @MainActor func addCommentsData(contentId: Int,
                         usercode: String,
                         description: String,
                         fullName: String,
                         imageUrl: String,
    ...
    @MainActor func addCommentOrReplyFavorite(commentId: Int?,
                                   replyId: Int?,
                                   isLiked: Bool,
                                   usercode: String,
                                   completion:
    ...
    @MainActor func getAllRepliessData(commentId: Int,
                            usercode: String,
                            completion:
    ...
    @MainActor func addRepliesData(contentId: Int,
                        description: String,
                        usercode: String,
                        fullName: String,
                        imageUrl: String,
