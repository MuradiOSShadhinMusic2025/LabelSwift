...
extension UIColor {
    ...
    static let bgBtnColor = UIColor(named: "bgBtnColor") ?? .black
    static let mainBgModeTypeColor = UIColor(named: "mainBgModeTypeColor") ?? .black
    static let textColorModeTypeColor = UIColor(named: "textColorModeTypeColor") ?? .black
    static let topBarModeTypeColor = UIColor(named: "topBarModeTypeColor") ?? .black
    static let textViewBgColor = UIColor(named: "textViewBgColor") ?? .black
    static let textColorSecoundery = UIColor(named : "textColorSecondury") ?? .darkGray
